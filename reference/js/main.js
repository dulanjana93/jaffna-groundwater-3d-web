...
function loadAssets() {
  ...
  let done = 0;
  const FILES = [
    { url:'../gnd-compressed.glb',                                   label:'Ground terrain',         pct:14 },
    ...
    { url:'../salt.glb',                                  label:'Saltwater layer',        pct:75 },
    { url:'../fresh.glb',                                 label:'Freshwater layer',       pct:86 },
    { url:'../clouds-compressed.glb',                     label:'Atmosphere layer',       pct:95 },
    { url:'../props.glb',                                 label:'objects',                pct:100 },
  ];
